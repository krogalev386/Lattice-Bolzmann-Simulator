...
int main() {
    std::shared_ptr<domain> dom = std::make_shared<domain>(0,1.104e-3,20,13);
    ...
    //std::cout << xt::view(rho_m, 4, xt::all()) << std::endl;
    //std::cout << xt::view(f_distr,xt::all(),xt::all(),0) << std::endl;
